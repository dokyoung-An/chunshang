...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='cursor : pointer;';
		hs+='height : 34.7222%;';
		hs+='left : calc(50% - ((53.9773% + 0px) / 2) + 0px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((34.7222% + 0px) / 2) - 8px);';
		hs+='visibility : hidden;';
		hs+='width : 53.9773%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._text_1.ggUpdateText=function() {
			var params = [];
			var hs = player._("\uc6b8\uc0b0\ucc9c\uc0c1\uc8fc\ud0dd\uc9c0\uad6c", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_9.ggUpdateText=function() {
			var params = [];
			var hs = player._("\uc548\ub155\ud558\uc138\uc694. \n\ud558\uc774\ud37c\ub9ac\uc5bc\ub9ac\uc998 \uc0ac\uc774\ubc84\ubaa8\ub378\ud558\uc6b0\uc2a4, \uc2e4\uc0ac VR, \ud56d\uacf5 VR \ucee8\ud150\uce20\ub97c \uc81c\uc791\ud558\ub294 \uc5b8\ud53d\uc158\uc785\ub2c8\ub2e4. \n\n\ud574\ub2f9 \ud56d\uacf5 VR\uc740 \uc6b8\uc0b0\ucc9c\uc0c1\uc8fc\ud0dd\uc9c0\uc758 \ubaa8\uc2b5 \ucd2c\uc601\ud55c \uac83\uc785\ub2c8\ub2e4. \n\uad50\ud1b5\uc740 \ubb3c\ub860\uc774\uace0 \ucd08, \uc911, \uace0\uac00 \ubc00\uc9d1\ub418\uc5b4 \uc788\uc744 \ubfd0 \uc544\ub2c8\ub77c \ud0dc\ud654\uac15 \uc8fc\ubcc0\uc758 \uc790\uc5f0\uacbd\uad00\uae4c\uc9c0\n\ub204\ub9b4 \uc218 \uc788\ub294 \uc6b8\uc0b0\ucc9c\uc0c1\uc9c0\uad6c\uc8fc\ud0dd\uc9c0\ub97c \ud655\uc778\ud574 \ubcf4\uc138\uc694. \n\n-----\n\uc0ac\uc774\ubc84\ubaa8\ub378\ud558\uc6b0\uc2a4 \ubc0f \uc2e4\uc0ac VR \uc81c\uc791\n- \ud68c\uc0ac\uba85 : \uc5b8\ud53d\uc158\n- \uace0\uac1d\uc13c\ud130 : 1566-5297\n- \ud648\ud398\uc774\uc9c0 : www.unfiction.kr", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
